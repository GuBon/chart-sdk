...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(
  { icon, className, wrapperClassName, size = 'md', ...props },
  ref,
) {
  ...
  if (!icon) {
    return (
      <input ref={ref} {...props} name={fallbackName} className={cn(field, 'w-full outline-none focus-visible:ring-2 focus-visible:ring-primary/20', className)} />
    );
  }
  return (
